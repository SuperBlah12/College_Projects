...
namespace SB12VisNov
{
    class SB12VisNov
    {
        ...
        public const string DIALOGUE = "[MODIFY THIS PART]\\PLAY\\Dialogue.visnov";
        public const string ASCIIART = "[MODIFY THIS PART]\\PLAY\\Art.ascii";
        public const string SAVING = "[MODIFY THIS PART]\\PLAY\\Save.game";
        public static string[] dialogue = File.ReadAllLines(DIALOGUE);//get all dialogue lines
        public static string[] asciiart = File.ReadAllLines(ASCIIART);//get all ascii art
        public static string[] savegame = File.ReadAllLines(SAVING);//get save data
